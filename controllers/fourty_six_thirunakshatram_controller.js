...
createDatePrice = async (req, res) => {
    try {
        ...
        await model.FourtySixThirunakshatramPrice.create(data).then((result) => {
...
getDatePrice = async (req, res) => {
    try {
        await model.FourtySixThirunakshatramPrice.findAll().then((result) => {
...
deleteDatePrice = async (req, res) => {
    try {
        ...
        await model.FourtySixThirunakshatramPrice.findOne({ where: { id: data["id"] } }).then((result) => {
            if (result) {
                model.FourtySixThirunakshatramPrice.destroy({ where: { id: data["id"] } }).then((x) => {
...
allBookings=async(req,res)=>{
    try {
        await model.FourtySixThirunakshatramBookings.findAll().then((result) => {
...
newBooking = async (req, res) => {
    try {
        ...
        await model.FourtySixThirunakshatramBookings.create(data).then((result) => {
...
myBookings = async (req, res) => {
    try {
        ...
        await model.FourtySixThirunakshatramBookings.findAll({ where: { user_id: data["user_id"] } }).then((result) => {
            return res.status(200).json(result);
        }).catch((err) => {
            return res.status(500).json({ message: "Not able to get data.", error: err });
        });
...
getBookingDetail = async (req, res) => {
    try {
        ...
        await model.FourtySixThirunakshatramBookings.findAll({ where: {id: data["id"] } }).then((result) => {
            return res.status(200).json(result);
        }).catch((err) => {
            return res.status(500).json({ message: "Not able to get data.", error: err });
        });
