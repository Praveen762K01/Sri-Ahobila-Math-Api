...
createDate = async (req, res) => {
    try {
        ...
        const existingDates = await model.Chatru_NithyaThadi_Master_Table.findAll({
            where: {
                [Op.or]: [
                    {
                        from_date: {
        ...
        await model.Chatru_NithyaThadi_Master_Table.update({ is_active: false }, {
            where: {
                is_active: true
            }
        });
        ...
        await model.Chatru_NithyaThadi_Master_Table.create(data);
