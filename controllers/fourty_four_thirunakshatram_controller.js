...
createDatePrice = async (req, res) => {
    try {
        ...
        await model.FourtyFourThirunakshatramPrice.create(data).then((result) => {
...
getDatePrice = async (req, res) => {
    try {
        await model.FourtyFourThirunakshatramPrice.findAll().then((result) => {
...
deleteDatePrice = async (req, res) => {
    try {
        ...
        await model.FourtyFourThirunakshatramPrice.findOne({ where: { id: data["id"] } }).then((result) => {
            if (result) {
                model.FourtyFourThirunakshatramPrice.destroy({ where: { id: data["id"] } }).then((x) => {
...
allBookings=async(req,res)=>{
    try {
        await model.FourtyFourThirunakshatramBookings.findAll().then((result) => {
            return res.status(200).json(result);
        }).catch((err) => {
...
newBooking = async (req, res) => {
    try {
        ...
        await model.FourtyFourThirunakshatramBookings.create(data).then((result) => {
...
myBookings = async (req, res) => {
    try {
        ...
        await model.FourtyFourThirunakshatramBookings.findAll({ where: { user_id: data["user_id"] } }).then((result) => {
            return res.status(200).json(result);
        }).catch((err) => {
            return res.status(500).json({ message: "Not able to get data.", error: err });
        });
...
getBookingDetail = async (req, res) => {
    try {
        ...
        await model.FourtyFourThirunakshatramBookings.findAll({ where: {id: data["id"] } }).then((result) => {
            return res.status(200).json(result);
        }).catch((err) => {
            return res.status(500).json({ message: "Not able to get data.", error: err });
        });
